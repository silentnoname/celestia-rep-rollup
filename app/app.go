...
import (
	...
	repmodule "rep/x/rep"
	repmodulekeeper "rep/x/rep/keeper"
	repmoduletypes "rep/x/rep/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "rep/app/params"
	"rep/docs"
)

const (
	AccountAddressPrefix = "rep"
	Name                 = "rep"
)
...
func New(
	...
	*/
	...
	app.RepKeeper = *repmodulekeeper.NewKeeper(
		appCodec,
		keys[repmoduletypes.StoreKey],
		keys[repmoduletypes.MemStoreKey],
		app.GetSubspace(repmoduletypes.ModuleName),
	)
	repModule := repmodule.NewAppModule(appCodec, app.RepKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(repmoduletypes.ModuleName)
