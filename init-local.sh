...
# build the rep chain with Rollkit
ignite chain build
...
repd add-genesis-account $KEY_3_NAME $TOKEN_AMOUNT --keyring-backend test
...
# start the chain
repd start --rollkit.aggregator true --rollkit.da_layer celestia --rollkit.da_config='{"base_url":"http://localhost:26659","timeout":60000000000,"fee":6000,"gas_limit":6000000}' --rollkit.namespace_id $NAMESPACE_ID --rollkit.da_start_height $DA_BLOCK_HEIGHT
